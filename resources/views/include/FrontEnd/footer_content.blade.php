        ...
        <aside class="ps-widget--footer ps-widget--info">
          <header>
            <a class="ps-logo" href="">
              <!-- <img src="{!! asset('public/assets/images/textonly-363x129.png') !!}" alt=""> -->
            </a>
          </header>
          <footer>
      ...
      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
        <aside class="ps-widget--footer ps-widget--link">
          ...
          <footer>
            ...
            <p> <a href="{!! asset('public/destkop/PermataBelajar1.msi') !!}"><img src="{!! asset('public/assets/images/icon/icon/Windows_badge.png') !!}" alt="" style="max-height: 70px;"></a></p>
          </footer>
        </aside>
      </div>
    </div>
