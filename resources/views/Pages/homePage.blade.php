...
<div class="carousel-inner">  
    <div class="item active">
      <a href="{{ route('Registrasi.index') }}">
        <img src="{!! asset('public/images/banner/1.png') !!}" alt="Los Angeles" style="width:100%; height: 180px;">
      </a>
    </div>
    <div class="item">
      <a href="{{ route('Registrasi.index') }}">
        <img src="{!! asset('public/images/banner/2.png') !!}" alt="Los Angeles" style="width:100%; height: 180px;">
      </a>
    </div>
    <div class="item">
      <a href="{{ route('Registrasi.index') }}">
