  ...
  <div class="row">
            ...
            <div class="shop-card">
              ...
              <div class="slider">
                <figure data-color="#E24938, #{{ random_color() }}">
                  <img src="http://3.bp.blogspot.com/-DRr13QVT13Q/VphgsIPGAoI/AAAAAAAAAMc/pJBWCh-9p8M/s1600/baie_server.jpg" />
                </figure>
                <figure data-color="#6CD96A, #{{ random_color() }}">
                  <img src="https://s2.bukalapak.com/img/7641670451/w-1000/Home_Button_Touch_ID_Cartoon_Sticker_Oppo_F1s_F3_F1_Plus_A59.jpg" />
                </figure>
                <figure data-color="#4795D1, #{{ random_color() }}">
                  <img src="https://research.pes.edu/wp-content/uploads/2017/07/default.jpg" />
                </figure>
                <figure data-color="#292a2f, #{{ random_color() }}">
                  <img src="https://s3.bukalapak.com/img/3695920564/w-1000/Flexiblehomefingerprintoppof3original_2_scaledjpg_scaled.jpg" />
                </figure>
              </div>
              <div class="cta">
    ...
    <div class="col-md-3">
      <div class="categori-kotak-2">
        <!-- start slider -->
        <span style="font-size: 18px;" onmouseover="kategori()">Kategori Produk</span>
