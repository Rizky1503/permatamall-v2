...
<div class="container">
  <div style="height: 300px;">
    <form method="post" action="{{ ENV('APP_URL_PAYMENT') }}Suite/Receive" id="form_doku_payment">
      <table width="600" border="0" cellspacing="1" cellpadding="5">
        <tr>
          ...
          <td width="100" class="field_input">
            <input name="BASKET" type="text" id="BASKET" value="Bimbel Online {{ $data->keterangan }} {{ $data->kondisi }} Paket 6 Bulan,{{ $data->amount }}.00,1,{{ $data->amount }}.00" />
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="field_input">
            <input name="NAME" type="text" id="NAME" value="{{ $data->nama }}" maxlength="50" />
          </td>
        </tr>
        <tr>
          <td class="field_label">ADDRESS</td>
          <td class="field_input">
            <input name="ADDRESS" type="text" id="ADDRESS" value="{{ $data->alamat }}" size="50" maxlength="50" />
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="field_input">
            <input name="HOMEPHONE" type="text" id="HOMEPHONE" value="{{ $data->no_telpon }}" size="12" maxlength="20" />
          </td>
        </tr>
        <tr>
          <td class="field_label">MOBILEPHONE</td>
          <td class="field_input">
            <input name="MOBILEPHONE" type="text" id="MOBILEPHONE" value="{{ $data->no_telpon }}" size="12" maxlength="20" />
          </td>
        </tr>
        <tr>
          <td class="field_label">WORKPHONE</td>
          <td class="field_input">
            <input name="WORKPHONE" type="text" id="WORKPHONE" size="12" maxlength="20" value="{{ $data->no_telpon }}" />
          </td>
        </tr>
        <tr>
          <td class="field_label">BIRTHDATE</td>
          <td class="field_input">
            <input name="BIRTHDATE" type="text" id="BIRTHDATE" value="{{ \Carbon\Carbon::parse($data->created_at)->format('Ymd') }}" size="12" maxlength="8" />
          </td>
        </tr>
        <tr>
