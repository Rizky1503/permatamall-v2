...
<body>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                @foreach($data as $ListData)
                    <div class="col-lg-4 col-md-7 col-sm-8" onclick="gopaket('{{ route('ExampPermataBimbelOnline.paket_more',[encrypt($ListData->id_paket)]) }}')" style="cursor: pointer;">
                        <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" style="background-image: url({{ ENV('APP_URL_API_RESOURCE').'images/paket/examp/'.$ListData->banner_paket }}); background-size: cover; width: 100%;">
                            <div class="services-content mt-30 content-height">                            
                            </div>
                        </div>
                    </div>
                @endforeach
                    <div class="col-lg-4 col-md-7 col-sm-8" onclick="gopaket('{{ route('ExampPermataBimbelOnline.pengembangan') }}')" style="cursor: pointer;">
                        <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" style="background-image: url({{ ENV('APP_URL_API_RESOURCE').'images/paket/examp/tryout.png'}}); background-size: cover; width: 100%;">
                            <div class="services-content mt-30 content-height">                            
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-7 col-sm-8" onclick="gopaket('{{ route('ExampPermataBimbelOnline.pengembangan') }}')" style="cursor: pointer;">
                        <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" style="background-image: url({{ ENV('APP_URL_API_RESOURCE').'images/paket/examp/intensif.png'}}); background-size: cover; width: 100%;">
                            <div class="services-content mt-30 content-height">                            
                            </div>
                        </div>
                    </div>
    ...
    <section id="about" class="about-area pt-70">
        ...
        <div class="about-shape-1">
            <img src="{{ asset('public/assets/assets_tmp/images/about-shape-12.png')}}" alt="shape">
        </div>
    </section>
                ...
                <div class="col-lg-3 col-md-7 col-sm-8">   
                  <a href="{{ route('FreeExamp.nambah_view',[$ListVideo->slug]) }}">
                        <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            <img style="width:100%;" src="{{ ENV('APP_URL_API_RESOURCE').'images/Video/banner/'.$ListVideo->kelas.'/'.$ListVideo->nama_matpel.'/'.$ListVideo->banner }}">
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="footer-link d-flex mt-50 justify-content-md-between">
                            <div class="link-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                                ...
                                <ul class="link">
                                    ...
                                    <li><a href="{{ route('Bantuan.bantuan') }}">Pusat Bantuan</a></li>
                                    <li><a href="#">Karir</a></li>
                                    <li><a href="#">Tentang Kami</a></li>
                                    <li><a href="{{ route('Refund.index') }}">Pengembalian Dana</a></li>
                    ...
                    <div class="col-lg-3 col-md-5 col-sm-5">
                        <div class="footer-contact mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                            ...
                            <ul class="contact">
                                <li><a href='https://play.google.com/store/apps/details?id=com.permatamall&hl=in'><img src="{!! asset('public/assets/images/icon/icon/cb935093.png') !!}" alt="" style="max-height: 70px;"></a></li>
    ...
    @media only screen and (min-width: 678px) and (max-width: 1023px) and (orientation: portrait) {
        .content-height{
            min-height: 343px;
        }
    }
    ...
    @media only screen and (min-width: 411px) and (max-width: 677px) and (orientation: portrait) {
        .content-height{
            min-height: 334px;
        }
    }
