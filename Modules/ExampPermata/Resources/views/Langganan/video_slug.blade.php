      ...
      <div class="col-sm-3 sidebar sidebar2">
          <div class="row m0 sidebar_row_inner">                            
              ...
              <div class="row m0 widget widget_popular_videos">
                  <h5 class="widget_title">Video serupa lainnya</h5>
                  <div class="row m0 inner">
                      @foreach($Serupa as $ListSerupa)
                      <div class="media">
                          <div class="media-left">
                            <a href="{{ route('ExampPermata.nambah_view',[$ListSerupa->slug]) }}">
                             <img src="{!! asset('public/images/bimbel_berbayar_icon/video.png') !!}" alt="" class="cast img-responsive" style="width: 83%"><span class="duration">{{ $ListSerupa->durasi }}</span>
                            </a>
                          </div>
