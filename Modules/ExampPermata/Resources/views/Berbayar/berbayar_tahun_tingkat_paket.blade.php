...
<div class="container" style="padding-bottom: 80px; padding-top: 50px;" id="seach_page">          
	<div class="row">
      ...
      <center><p>KURIKULLUM 2013</p></center>
      ...
      <div class="panel panel-default">
        <div class="panel-body" style="border-bottom: 1px solid #f5f5f5; padding: 15px 15px 1px 15px; background-color: #e0f9e0;">
          <div class="form-group">
            ...
            <div class="col-md-6">
              @if($data->Data->kelas == 'KELAS 12 IPA' || $data->Data->kelas == 'KELAS 12 IPS')
              <a href="{{ route('ExampPermata.after_jenis',encrypt([$data->Data->id_order,$data->Data->id_package_user,$value->jenis_paket,$value->images]))}} ">
              @else              
              <a href="{{ route('ExampPermata.after_tahun',encrypt([$data->Data->id_order,$data->Data->id_package_user,'2020',$value->jenis_paket,$value->images]))}} ">
              @endif
              <img class=" img-fluid" src="{!! asset('public/images/bimbel_berbayar_icon/'.$value->images) !!}" alt="card image" style="width: 90%;">
              </a>
            </div>
            @endforeach
          </div> 
