...
<form class="m-form" id="form_add">	
	...
	<div class="m-portlet m-portlet--tab">
		...
		<div class="m-portlet__body">
			<div class="form-group m-form__group">
				...
				<input type="text" name="nama_barang" class="form-control m-input" id="nama_barang" aria-describedby="emailHelp" placeholder="Masukan nama barang" value="{{ $Data->nama_produk }}">
			</div>
			<div class="form-group m-form__group">
	...
	<div class="m-portlet m-portlet--tab">
		...
		<div class="m-portlet__body">
				...
				<div class="col-md-6">
					<div class="form-group m-form__group">
						...
						<div class="input-group m-input-group">
							...
							<input type="text" name="harga" class="form-control m-input" placeholder="masukan harga" aria-describedby="basic-addon1" id="harga" value="{{ $Data->harga }}">
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group m-form__group">
						...
						<div class="input-group">				
							<input type="text" name="stok" class="form-control" aria-label="Text input with dropdown button" placeholder="Masukan jumlah stok barang" id="stok" value="{{ $Data->stok }}">
						</div>
					</div>				
				</div>
			</div>
			<div class="form-group m-form__group">
				<label for="nama_barang">
					Kondisi Barang {{ $Data->kondisi_barang }}
				</label>
				<div class="m-radio-inline">
					<label class="m-radio">
						<input type="radio" name="kondisi_barang" value="baru" @if($Data->kondisi_barang == "baru") checked @endif>
						Baru
						<span></span>
					</label>
					<label class="m-radio">
						<input type="radio" name="kondisi_barang" value="bekas" @if($Data->kondisi_barang == "bekas") checked @endif>
						Bekas
						<span></span>
					</label>
				</div>
			...
			<div class="form-group m-form__group">
				...
				<div class="m-radio-inline">
					<label class="m-radio">
						<input type="radio" name="barang_import" value="Ya" @if($Data->barang_import == "Ya") checked @endif>
						Ya
						<span></span>
					</label>
					<label class="m-radio">
						<input type="radio" name="barang_import" value="Tidak" @if($Data->barang_import == "Tidak") checked @endif>
						Tidak
						<span></span>
					</label>
				</div>
